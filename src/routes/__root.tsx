...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Eain Pro" },
      { property: "og:title", content: "Eain Pro — Trusted home services in Myanmar" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;600;700&family=Noto+Sans+Myanmar:wght@400;600&display=swap",
      },
    ],
  }),
