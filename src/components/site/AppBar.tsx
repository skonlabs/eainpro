    ...
    >
      <div className="mx-auto flex h-14 max-w-screen-md items-center gap-2 px-3 sm:px-4">
        ...
        <button
          ...
          className="inline-flex h-10 min-w-14 items-center justify-center rounded-full border border-border bg-card px-3 text-sm font-bold tracking-wide text-muted-foreground hover:bg-secondary"
