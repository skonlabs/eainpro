      ...
      >
        ...
        <div
          className={cn(
            ...
            "group-data-[side=left]:w-[calc(var(--sidebar-width)+var(--sidebar-offset-left,0px))]",
            "group-data-[side=right]:w-[calc(var(--sidebar-width)+var(--sidebar-offset-right,0px))]",
            "group-data-[collapsible=offcanvas]:w-0",
            "group-data-[side=right]:rotate-180",
            variant === "floating" || variant === "inset"
              ? "group-data-[collapsible=icon]:group-data-[side=left]:w-[calc(var(--sidebar-width-icon)+theme(spacing.4)+var(--sidebar-offset-left,0px))] group-data-[collapsible=icon]:group-data-[side=right]:w-[calc(var(--sidebar-width-icon)+theme(spacing.4)+var(--sidebar-offset-right,0px))]"
              : "group-data-[collapsible=icon]:group-data-[side=left]:w-[calc(var(--sidebar-width-icon)+var(--sidebar-offset-left,0px))] group-data-[collapsible=icon]:group-data-[side=right]:w-[calc(var(--sidebar-width-icon)+var(--sidebar-offset-right,0px))]",
          )}
        />
        <div
          className={cn(
            ...
            side === "left"
              ? "left-[var(--sidebar-offset-left,0px)] group-data-[collapsible=offcanvas]:left-[calc((var(--sidebar-width)+var(--sidebar-offset-left,0px))*-1)]"
              : "right-[var(--sidebar-offset-right,0px)] group-data-[collapsible=offcanvas]:right-[calc((var(--sidebar-width)+var(--sidebar-offset-right,0px))*-1)]",
